////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  unit ArcIWOperaComboBox                                                   //
//    Copyright 2002 by Arcana Technologies Incorporated                      //
//    Written By Jason Southwell                                              //
//                                                                            //
//  Description:                                                              //
//    This component provides an Opera friendly version of the TIWComboBox    //
//                                                                            //
...
//                                                                            //
//  Updates:                                                                  //
//    07/27/2002 - Released to TArcIWOperaComboBox to Open Source.            //
...
uses
  Windows, Messages, SysUtils, Classes, IWControl, IWTypes, IWCompListbox,
...
type
  TArcIWOperaComboBox = class(TIWComboBox)
  private
  protected
  public
{$IFNDEF IWVERSION150}
...
constructor TArcIWOperaComboBox.Create(AOwner: TComponent);
var
...
{$IFDEF IWVERCLASS5}
function TArcIWOperaComboBox.RenderHTML: TIWHTMLTag;
begin
...
{$ELSE}
{$IFDEF IWVERSION70}
function TArcIWOperaComboBox.RenderHTML(AContext: TIWBaseHTMLComponentContext): TIWHTMLTag;
{$ELSE}
function TArcIWOperaComboBox.RenderHTML(AContext: TIWBaseComponentContext): TIWHTMLTag;
{$ENDIF}
begin
