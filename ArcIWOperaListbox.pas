////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  unit ArcIWOperaListbox                                                    //
//    Copyright 2002 by Arcana Technologies Incorporated                      //
//    Written By Jason Southwell                                              //
//                                                                            //
//  Description:                                                              //
//    This component provides an Opera friendly version of the TIWListbox     //
//                                                                            //
...
type
  TArcIWOperaListbox = class(TIWListbox)
  private
  protected
  public
{$IFNDEF IWVERSION150}
...
{$IFDEF IWVERCLASS5}
function TArcIWOperaListbox.RenderHTML: TIWHTMLTag;
begin
...
{$ELSE}
{$IFDEF IWVERSION70}
function TArcIWOperaListbox.RenderHTML(AContext: TIWBaseHTMLComponentContext): TIWHTMLTag;
{$ELSE}
function TArcIWOperaListbox.RenderHTML(AContext: TIWBaseComponentContext): TIWHTMLTag;
{$ENDIF}
begin
